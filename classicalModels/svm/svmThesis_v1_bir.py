...
resultGraphBase="43multiExpResulBir\\"
# load the new file
...
for lagLat in lagLatRange:
    for expNum in expNumRange:
        print("Current Lopps param expNum:",expNum," lagLat:",lagLat)
...
#        build_model_M(n_timesteps, n_features,out_vars,nNurons,auxInputDim=0,mergemod='concat')
        ...
        plt.clf()
        key="_".join([dataSrc,modelName,str(expNum),str(lagLat),str(lagLat),"_".join(np.array(nNurons[0]).astype(str)),"mseTrain"])
